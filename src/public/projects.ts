...
export const projects: IProjects = {
  kworks: {
    ...
    result: [
      '데이터를 파싱하고 지도와 데이터 그리드로 효과적으로 표현하는 작업에 참여하였고 총 38개의 사업을 성공적으로 수행하였습니다.',
  ...
  defi: {
    ...
    result: [
      '사용자들에게 직관적이고 편리한 서비스 경험을 제공하여 사용자들의 만족도를 높일 수 있었습니다.',
      '사용자들이 편리하게 암호 화폐를 예치하고 보상을 받을 수 있는 사용자 친화적인 인터페이스를 구현하여 서비스의 활용률을 높일 수 있었습니다.',
    ],
    precept: [
  ...
  cloud88: {
    ...
    summary: 'FWS, 클라우드 및 코로케이션 서비스를 제공하는 Cloud88 서비스를 소개하는 프로덕트입니다.',
    major: [
      'Boilerplate 구축 등 프로젝트 세팅과 인프라 구축을 담당하였습니다.',
      '모든 페이지와 기능을 구현하였습니다.',
      'Next.js 프레임워크를 활용하여 페이지 라우터를 개발하고, 재사용 할 수 있는 공통 컴포넌트와 커스텀 훅을 구현하였습니다.',
      'TypeScript, Styled-components, Axios 등의 툴을 사용하였습니다.',
      'Git-flow 전략을 활용하여 버전 관리를 수행하였으며, 프로젝트의 효율적인 협업을 위해 Slack, Figma 등의 각종 툴을 활용하였습니다.',
      'styled-components를 활용하여 CSS 프레임워크를 적용하고, 스타일링을 담당하였습니다.',
      'RESTful API를 통해 데이터 통신을 관리하였고, AWS Amplify를 활용하여 프로젝트 인프라를 구축하였습니다.',
    ],
    result: [
      '디자이너와 1:1로 진행하게 되었으며 원활한 협업을 통해 프로젝트 일정을 준수하고 목표를 달성하였습니다.',
      'styled-components 및 기타 다양한 라이브러리와 유틸을 프로젝트에 적용하여, 프로젝트의 개발 및 배포를 성공적으로 완료하였습니다.',
      '디자인과 퍼블리싱에 중점을 두어 사용자에게 직관적이고 쉬운 사용성을 제공할 수 있었고 브랜드의 이미지를 높일 수 있었습니다.',
    ],
    precept: [
      '지금까지의 경험과는 상대적으로 유려한 디자인과 다양한 페이지의 퍼블리싱을 진행하며 여러 화면 조작 css, 애니메이션등 많은 스킬들을 얻게 되었고 이러한 노력이 결국 정보를 효과적으로 전달할 수 있게 하고 브랜드 이미지에도 영향을 줄 수 있다는 점을 체감할 수 있었습니다.',
    ],
    images: ['image_projects_7_1.png', 'image_projects_7_2.png', 'image_projects_7_3.png'],
    link: {
      url: 'https://www.cloud88.co.kr/',
    },
    skills: [
      'TypeScript',
      'Next.js',
